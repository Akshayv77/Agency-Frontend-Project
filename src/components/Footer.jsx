    ...
    sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                ...
                <p className='max-w-md'> From stratergy to execution, we craft digital solutions that mopve your business forward.
                </p>
                <ul className='flex gap-8'>
                    <li><a href="#hero" className='hover:text-primary'>Home</a></li>
                    <li><a href="#services" className='hover:text-primary'>Services</a></li>
                    <li><a href="#our-wrok" className='hover:text-primary'>Our Work</a></li>
            ...
            className='text-gray-600 dark:text-gray-400'>
                ...
                <p className='text-sm mt-2 mb-6'> The latest news, articles, and resources, sent to your inbox.</p>
                <div className='flex gap-2 text-sm'>
                    <input type="email" placeholder='Enter your email' className='w-full p-3 text-sm outline-none rounded dark:text-gray-200
                    bg-transparent border bordder-gray-300 dark:border-gray-500' />
