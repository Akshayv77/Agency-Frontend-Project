...
const ContactUs = () => {
    ...
    formData.append("access_key", "53bd0aa2-d7ca-4ec9-801d-8112f7bf663b");
    try {
  ...
  return (
    ...
    id='contact-us'className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white'>
      <Title title='Reach out to us' desc='From stratergy to execution, we craft digital solutions that move your business forward'>
      </Title>
      <motion.form 
      ...
      className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full' onSubmit={onSubmit}>
        ...
        <textarea rows={8} name='message' placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounded-lg 
         border border-gray-300 dark:border-gray-600' required></textarea>
        </div>
